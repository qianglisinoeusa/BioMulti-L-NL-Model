...
if __name__ == '__main__':
    ...
    ############################################################################  
    image=cv2.imread('/home/qiang/QiangLi/Python_Utils_Functional/BioMulti-L-NL-Model/imgs/man.jpg', cv2.IMREAD_UNCHANGED)
  ...
  ############################################################################
    ...
    plt.show()
    #---------------------------------------------------
    #Enhance Saliency Map with DN Funtional
    #---------------------------------------------------
    Saliency_En = normalize_saliency_map(Saliency, cdf, cdf_bins)
    plt.figure(figsize=(12,10))
    plt.imshow(Saliency_En, cmap='gray')
    plt.axis('off')
    plt.title('Saliency Map Enhance')
    plt.show()
